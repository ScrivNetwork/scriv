                                    ...
                                    CConnman& connman)
{
    ...
    if(vote.GetTimescriv() < voteInstance.nCreationTime) {
        std::ostringstream ostr;
    ...
    voteInstance = vote_instance_t(vote.GetOutcome(), nVoteTimeUpdate, vote.GetTimescriv());
        ...
        if((nObjectType == GOVERNANCE_OBJECT_TRIGGER) || (nObjectType == GOVERNANCE_OBJECT_WATCHDOG)) {
            ...
            if(!mnodeman.GetMasternodeInfo(vinMasternode.prevout, infoMn)) {
                ...
                if (err == CMasternode::COLLATERAL_OK) {
                    ...
                    strError = "Masternode UTXO should have 100000 SCRIV, missing masternode=" + strOutpoint + "\n";
                }
