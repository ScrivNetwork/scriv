...
UniValue getnewaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "\nReturns a new Scriv address for receiving payments.\n"
            "If 'account' is specified (DEPRECATED), it is added to the address book \n"
            "so payments received with the address will be credited to 'account'.\n"
            "\nArguments:\n"
            "1. \"account\"        (string, optional) DEPRECATED. The account name for the address to be linked to. If not provided, the default account \"\" is used. It can also be set to the empty string \"\" to represent the default account. The account does not need to exist, it will be created if there is no account by the given name.\n"
            "\nResult:\n"
            "\"scrivaddress\"    (string) The new scriv address\n"
            "\nExamples:\n"
...
UniValue getaccountaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nDEPRECATED. Returns the current Scriv address for receiving payments to this account.\n"
            "\nArguments:\n"
            "1. \"account\"       (string, required) The account name for the address. It can also be set to the empty string \"\" to represent the default account. The account does not need to exist, it will be created and a new address created  if there is no account by the given name.\n"
            "\nResult:\n"
            "\"scrivaddress\"   (string) The account scriv address\n"
            "\nExamples:\n"
...
UniValue getrawchangeaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "getrawchangeaddress\n"
            "\nReturns a new Scriv address, for receiving change.\n"
...
UniValue setaccount(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            "setaccount \"scrivaddress\" \"account\"\n"
            "\nDEPRECATED. Sets the account associated with the given address.\n"
            "\nArguments:\n"
            "1. \"scrivaddress\"  (string, required) The scriv address to be associated with an account.\n"
            "2. \"account\"         (string, required) The account to assign the address to.\n"
            "\nExamples:\n"
            + HelpExampleCli("setaccount", "\"sRCHChFmxDmnyLs6sVBNSpwuadLUPfXcuN\" \"tabby\"")
            + HelpExampleRpc("setaccount", "\"sRCHChFmxDmnyLs6sVBNSpwuadLUPfXcuN\", \"tabby\"")
        );
    ...
    if (!address.IsValid())
        throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid Scriv address");
...
UniValue getaccount(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "getaccount \"scrivaddress\"\n"
            "\nDEPRECATED. Returns the account associated with the given address.\n"
            "\nArguments:\n"
            "1. \"scrivaddress\"  (string, required) The scriv address for account lookup.\n"
            "\nResult:\n"
            "\"accountname\"        (string) the account address\n"
            "\nExamples:\n"
            + HelpExampleCli("getaccount", "\"sRCHChFmxDmnyLs6sVBNSpwuadLUPfXcuN\"")
            + HelpExampleRpc("getaccount", "\"sRCHChFmxDmnyLs6sVBNSpwuadLUPfXcuN\"")
        );
...
UniValue getaddressesbyaccount(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "  \"scrivaddress\"  (string) a scriv address associated with the given account\n"
            "  ,...\n"
            "]\n"
            "\nExamples:\n"
...
UniValue sendtoaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 7)
        throw runtime_error(
            "sendtoaddress \"scrivaddress\" amount ( \"comment\" \"comment-to\" subtractfeefromamount use_is use_ps )\n"
            "\nSend an amount to a given address.\n"
            + HelpRequiringPassphrase() +
            "\nArguments:\n"
            "1. \"scrivaddress\" (string, required) The scriv address to send to.\n"
            ...
            "                             The recipient will receive less amount of Scriv than you enter in the amount field.\n"
            ...
            "\nExamples:\n"
            + HelpExampleCli("sendtoaddress", "\"sRCHChFmxDmnyLs6sVBNSpwuadLUPfXcuN\" 0.1")
            + HelpExampleCli("sendtoaddress", "\"sRCHChFmxDmnyLs6sVBNSpwuadLUPfXcuN\" 0.1 \"donation\" \"seans outpost\"")
            + HelpExampleCli("sendtoaddress", "\"sRCHChFmxDmnyLs6sVBNSpwuadLUPfXcuN\" 0.1 \"\" \"\" true")
            + HelpExampleRpc("sendtoaddress", "\"sRCHChFmxDmnyLs6sVBNSpwuadLUPfXcuN\", 0.1, \"donation\", \"seans outpost\"")
        );
...
UniValue instantsendtoaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 5)
        throw runtime_error(
            "instantsendtoaddress \"scrivaddress\" amount ( \"comment\" \"comment-to\" subtractfeefromamount )\n"
            ...
            "\"transactionid\"  (string) The transaction id.\n"
            "\nExamples:\n"
            + HelpExampleCli("instantsendtoaddress", "\"sRCHChFmxDmnyLs6sVBNSpwuadLUPfXcuN\" 0.1")
            + HelpExampleCli("instantsendtoaddress", "\"sRCHChFmxDmnyLs6sVBNSpwuadLUPfXcuN\" 0.1 \"donation\" \"seans outpost\"")
            + HelpExampleCli("instantsendtoaddress", "\"sRCHChFmxDmnyLs6sVBNSpwuadLUPfXcuN\" 0.1 \"\" \"\" true")
            + HelpExampleRpc("instantsendtoaddress", "\"sRCHChFmxDmnyLs6sVBNSpwuadLUPfXcuN\", 0.1, \"donation\", \"seans outpost\"")
        );
...
UniValue listaddressgroupings(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp)
        throw runtime_error(
            ...
            "  [\n"
            "    [\n"
            "      \"scrivaddress\",     (string) The scriv address\n"
...
UniValue signmessage(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 2)
        throw runtime_error(
            "signmessage \"scrivaddress\" \"message\"\n"
            "\nSign a message with the private key of an address"
            + HelpRequiringPassphrase() + "\n"
            "\nArguments:\n"
            "1. \"scrivaddress\"  (string, required) The scriv address to use for the private key.\n"
            ...
            + HelpExampleCli("signmessage", "\"sRCHChFmxDmnyLs6sVBNSpwuadLUPfXcuN\" \"my message\"") +
            "\nVerify the signature\n"
            + HelpExampleCli("verifymessage", "\"sRCHChFmxDmnyLs6sVBNSpwuadLUPfXcuN\" \"signature\" \"my message\"") +
            "\nAs json rpc\n"
            + HelpExampleRpc("signmessage", "\"sRCHChFmxDmnyLs6sVBNSpwuadLUPfXcuN\", \"my message\"")
        );
...
UniValue getreceivedbyaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 3)
        throw runtime_error(
            "getreceivedbyaddress \"scrivaddress\" ( minconf addlockconf )\n"
            "\nReturns the total amount received by the given scrivaddress in transactions with specified minimum number of confirmations.\n"
            "\nArguments:\n"
            "1. \"scrivaddress\"  (string, required) The scriv address for transactions.\n"
            ...
            + HelpExampleCli("getreceivedbyaddress", "\"sRCHChFmxDmnyLs6sVBNSpwuadLUPfXcuN\"") +
            "\nThe amount including unconfirmed transactions, zero confirmations\n"
            + HelpExampleCli("getreceivedbyaddress", "\"sRCHChFmxDmnyLs6sVBNSpwuadLUPfXcuN\" 0") +
            "\nThe amount with at least 6 confirmation, very safe\n"
            + HelpExampleCli("getreceivedbyaddress", "\"sRCHChFmxDmnyLs6sVBNSpwuadLUPfXcuN\" 6") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("getreceivedbyaddress", "\"sRCHChFmxDmnyLs6sVBNSpwuadLUPfXcuN\", 6")
       );
...
UniValue movecmd(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 3 || params.size() > 5)
        throw runtime_error(
            ...
            "\nMove 0.01 " + CURRENCY_UNIT + " timotei to akiko with a comment and funds have 15 confirmations\n"
...
UniValue sendfrom(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 3 || params.size() > 7)
        throw runtime_error(
            "sendfrom \"fromaccount\" \"toscrivaddress\" amount ( minconf addlockconf \"comment\" \"comment-to\" )\n"
            "\nDEPRECATED (use sendtoaddress). Sent an amount from an account to a scriv address."
            + HelpRequiringPassphrase() + "\n"
            "\nArguments:\n"
            "1. \"fromaccount\"    (string, required) The name of the account to send funds from. May be the default account using \"\".\n"
            "2. \"toscrivaddress\"  (string, required) The scriv address to send funds to.\n"
            ...
            + HelpExampleCli("sendfrom", "\"\" \"sRCHChFmxDmnyLs6sVBNSpwuadLUPfXcuN\" 0.01") +
            "\nSend 0.01 from the tabby account to the given address, funds must have at least 6 confirmations\n"
            + HelpExampleCli("sendfrom", "\"tabby\" \"sRCHChFmxDmnyLs6sVBNSpwuadLUPfXcuN\" 0.01 6 false \"donation\" \"seans outpost\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendfrom", "\"tabby\", \"sRCHChFmxDmnyLs6sVBNSpwuadLUPfXcuN\", 0.01, 6, false, \"donation\", \"seans outpost\"")
        );
...
UniValue sendmany(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 8)
        throw runtime_error(
            ...
            "    {\n"
            "      \"address\":amount     (numeric or string) The scriv address is the key, the numeric amount (can be string) in " + CURRENCY_UNIT + " is the value\n"
            "      ,...\n"
            "    }\n"
            ...
            "                           Those recipients will receive less scrivs than you enter in their corresponding amount field.\n"
            ...
            + HelpExampleCli("sendmany", "\"tabby\" \"{\\\"sRCHChFmxDmnyLs6sVBNSpwuadLUPfXcuN\\\":0.01,\\\"XuQQkwA4FYkq2XERzMY2CiAZhJTEDAbtcg\\\":0.02}\"") +
            "\nSend two amounts to two different addresses setting the confirmation and comment:\n"
            + HelpExampleCli("sendmany", "\"tabby\" \"{\\\"sRCHChFmxDmnyLs6sVBNSpwuadLUPfXcuN\\\":0.01,\\\"XuQQkwA4FYkq2XERzMY2CiAZhJTEDAbtcg\\\":0.02}\" 6 false \"testing\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendmany", "\"tabby\", \"{\\\"sRCHChFmxDmnyLs6sVBNSpwuadLUPfXcuN\\\":0.01,\\\"XuQQkwA4FYkq2XERzMY2CiAZhJTEDAbtcg\\\":0.02}\", 6, false, \"testing\"")
        );
    ...
    BOOST_FOREACH(const string& name_, keys)
    {
        ...
        if (!address.IsValid())
            throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, string("Invalid Scriv address: ")+name_);
...
UniValue addmultisigaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 3)
    {
        string msg = "addmultisigaddress nrequired [\"key\",...] ( \"account\" )\n"
            ...
            "Each key is a Scriv address or hex-encoded public key.\n"
            "If 'account' is specified (DEPRECATED), assign address to that account.\n"

            "\nArguments:\n"
            "1. nrequired        (numeric, required) The number of required signatures out of the n keys or addresses.\n"
            "2. \"keysobject\"   (string, required) A json array of scriv addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"address\"  (string) scriv address or hex-encoded public key\n"
            "       ...,\n"
            "     ]\n"
            "3. \"account\"      (string, optional) DEPRECATED. An account to assign the addresses to.\n"

            "\nResult:\n"
            "\"scrivaddress\"  (string) A scriv address associated with the keys.\n"
...
UniValue listtransactions(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 4)
        throw runtime_error(
            ...
            "    \"address\":\"scrivaddress\",  (string) The scriv address of the transaction. Not present for \n"
...
UniValue listsinceblock(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp)
        throw runtime_error(
            ...
            "    \"address\":\"scrivaddress\",  (string) The scriv address of the transaction. Not present for move transactions (category = move).\n"
...
UniValue gettransaction(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "      \"address\" : \"scrivaddress\",      (string) The scriv address involved in the transaction\n"
...
UniValue walletpassphrase(const UniValue& params, bool fHelp)
{
    ...
    if (pwalletMain->IsCrypted() && (fHelp || params.size() < 2 || params.size() > 3))
        throw runtime_error(
            ...
            "This is needed prior to performing transactions related to private keys such as sending scrivs\n"
            "\nArguments:\n"
...
UniValue walletlock(const UniValue& params, bool fHelp)
{
    ...
    if (pwalletMain->IsCrypted() && (fHelp || params.size() != 0))
        throw runtime_error(
            ...
            + HelpExampleCli("sendtoaddress", "\"sRCHChFmxDmnyLs6sVBNSpwuadLUPfXcuN\" 1.0") +
...
UniValue encryptwallet(const UniValue& params, bool fHelp)
{
    ...
    if (!pwalletMain->IsCrypted() && (fHelp || params.size() != 1))
        throw runtime_error(
            ...
            "\nNow set the passphrase to use the wallet, such as for signing or sending scriv\n"
            + HelpExampleCli("walletpassphrase", "\"my pass phrase\"") +
            "\nNow we can so something like sign\n"
            + HelpExampleCli("signmessage", "\"scrivaddress\" \"test message\"") +
    ...
    StartShutdown();
    return "Wallet encrypted; Scriv Core server stopping, restart to run with encrypted wallet. The keypool has been flushed and a new HD seed was generated (if you are using HD). You need to make a new backup.";
}
...
UniValue lockunspent(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "A locked transaction output will not be chosen by automatic coin selection, when spending scrivs.\n"
...
UniValue getwalletinfo(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"keypoololdest\": xxxxxx,    (numeric) the timescriv (seconds since GMT epoch) of the oldest pre-generated key in the key pool\n"
            ...
            "  \"unlocked_until\": ttt,      (numeric) the timescriv in seconds since epoch (midnight Jan 1 1970 GMT) that the wallet is unlocked for transfers, or 0 if the wallet is locked\n"
...
UniValue listunspent(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 3)
        throw runtime_error(
            ...
            "3. \"addresses\"      (string) A json array of scriv addresses to filter\n"
            "    [\n"
            "      \"address\"     (string) scriv address\n"
            "      ,...\n"
            "    ]\n"
            "\nResult\n"
            ...
            "    \"vout\" : n,               (numeric) the vout value\n"
            "    \"address\" : \"address\",    (string) the scriv address\n"
            ...
            "\nExamples\n"
            + HelpExampleCli("listunspent", "")
            + HelpExampleCli("listunspent", "6 9999999 \"[\\\"sRCHChFmxDmnyLs6sVBNSpwuadLUPfXcuN\\\",\\\"XuQQkwA4FYkq2XERzMY2CiAZhJTEDAbtcg\\\"]\"")
            + HelpExampleRpc("listunspent", "6, 9999999 \"[\\\"sRCHChFmxDmnyLs6sVBNSpwuadLUPfXcuN\\\",\\\"XuQQkwA4FYkq2XERzMY2CiAZhJTEDAbtcg\\\"]\"")
        );
    ...
    if (params.size() > 2) {
        ...
        for (unsigned int idx = 0; idx < inputs.size(); idx++) {
            ...
            if (!address.IsValid())
                throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, string("Invalid Scriv address: ")+input.get_str());
            if (setAddress.count(address))
