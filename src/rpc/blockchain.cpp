...
UniValue getblockhashes(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 2)
        throw runtime_error(
            "getblockhashes timescriv\n"
            "\nReturns array of hashes of blocks within the timescriv range provided.\n"
            "\nArguments:\n"
            "1. high         (numeric, required) The newer block timescriv\n"
            "2. low          (numeric, required) The older block timescriv\n"
            "\nResult:\n"
            "[\n"
    ...
    if (!GetTimescrivIndex(high, low, blockHashes)) {
...
UniValue gettxout(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3)
        throw runtime_error(
            ...
            "     \"addresses\" : [          (array of string) array of scriv addresses\n"
