...
UniValue getpeerinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "    \"subver\": \"/Scriv Core:x.x.x/\",  (string) The string version\n"
...
UniValue addnode(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 2 ||
        ...
        throw runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("addnode", "\"192.168.0.6:8999\" \"onetry\"")
            + HelpExampleRpc("addnode", "\"192.168.0.6:8999\", \"onetry\"")
        );
...
UniValue disconnectnode(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "1. \"node\"     (string, required) The node (see getpeerinfo for nodes)\n"
            "\nExamples:\n"
            + HelpExampleCli("disconnectnode", "\"192.168.0.6:8999\"")
            + HelpExampleRpc("disconnectnode", "\"192.168.0.6:8999\"")
        );
...
UniValue getaddednodeinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "       {\n"
            "         \"address\" : \"192.168.0.201:7979\",  (string) The scriv server IP and port we're connected to\n"
...
UniValue getnetworkinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"subversion\": \"/Scriv Core:x.x.x/\",     (string) the server subversion string\n"
...
UniValue setban(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 ||
        ...
        throw runtime_error(
                            ...
                            "4. \"absolute\"     (boolean, optional) If set, the bantime must be a absolute timescriv in seconds since epoch (Jan 1 1970 GMT)\n"
                            "\nExamples:\n"
