...
UniValue masternodelist(const UniValue& params, bool fHelp)
{
                ...
                strMode != "rank" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  lastseen       - Print timescriv of when a masternode was last seen on the network\n"
                "  payee          - Print Scriv address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
