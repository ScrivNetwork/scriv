    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Scriv Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Scriv address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and scriv: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Scriv Core"), this);
    aboutAction->setStatusTip(tr("Show information about Scriv Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Scriv Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Scriv addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Scriv addresses"));
    ...
    openAction->setStatusTip(tr("Open a scriv: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Scriv Core help message to get a list with possible Scriv Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Scriv Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Scriv network", "", count));
    } else {
...
{
    QString strTitle = tr("Scriv Core"); // default title
