    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Scriv Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Scriv Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  scriv-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Scriv in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 SCRIV, 0.1 SCRIV, 1 SCRIV and 10 SCRIV -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Scriv Core is shutting down...") + "<br /><br />" +
