...
public:
    ...
    // because it's used in many Scriv-specific places (masternode, privatesend).
...
/** Return a timescriv in the future (in microseconds) for exponentially distributed events. */
