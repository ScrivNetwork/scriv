...
#define BOOST_TEST_MODULE Scriv Test Suite

#include "test_scriv.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_scriv_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
